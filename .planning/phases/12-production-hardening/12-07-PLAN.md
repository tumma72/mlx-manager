...
must_haves:
  truths:
    ...
    - "CLI is accessible via mlx-benchmark command"
  artifacts:
    ...
    - path: "backend/mlx_manager/mlx_server/benchmark/cli.py"
      provides: "CLI entry point for benchmarks"
      exports: ["main", "app"]
  ...
  key_links:
    ...
    - from: "pyproject.toml"
      ...
      pattern: "mlx-benchmark.*benchmark\\.cli"
---
