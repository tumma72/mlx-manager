...
- [ ] 06-17-PLAN.md — Extensionless text file attachment support (gap closure)
- [ ] 06-18-PLAN.md — Tool-use badge reliability + 204 for missing configs (gap closure)
...
| 6. Bug Fixes & Stability | 16/18 | In Progress | - |
