...
- [x] **Phase 5: Chat Multimodal & Enhancements** - Image/video attachments, thinking models, MCP mock, tool-use badge, profile enhancements
...
**Success Criteria** (what must be TRUE):
  ...
  22. Extensionless text files (README, Makefile, Dockerfile) accepted as attachments ✓
  23. Tool-use badge reliably shown on known capable model families (no 404 console errors) ✓
...
- [x] 06-17-PLAN.md — Extensionless text file attachment support (gap closure)
- [x] 06-18-PLAN.md — Tool-use badge reliability + 204 for missing configs (gap closure)
...
| 6. Bug Fixes & Stability | 18/18 | ✓ Complete | 2026-01-25 |
