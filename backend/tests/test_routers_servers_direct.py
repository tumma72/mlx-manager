...
from mlx_manager.models import RunningInstance, ServerProfile, User, UserStatus
...
class TestListRunningServersDirect:
    ...
    async def test_list_running_servers_empty(self):
        ...
        with patch("mlx_manager.routers.servers.server_manager") as mock_sm:
            ...
            result = await list_running_servers(current_user=mock_user, session=mock_session)
...
class TestStopServerDirect:
    ...
    async def test_stop_server_success(self):
        ...
        with patch("mlx_manager.routers.servers.server_manager") as mock_sm:
            ...
            result = await stop_server(current_user=mock_user, profile_id=1, session=mock_session)
    ...
    async def test_stop_server_not_running(self):
        ...
        with patch("mlx_manager.routers.servers.server_manager") as mock_sm:
            ...
            with pytest.raises(HTTPException) as exc_info:
                await stop_server(current_user=mock_user, profile_id=1, session=mock_session)
